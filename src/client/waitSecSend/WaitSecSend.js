    ...
    return (
        <div style={{marginTop: '3em'}} className='inputs'>
            ...
            <div className="input-group">
                ...
                <input ref={value} onChange={()=>val()} type="text" aria-label="First name" className="form-control"/>
                <span className="input-group-text">До</span>
                <input ref={value2} onChange={()=>val2()} type="text" aria-label="Last name" className="form-control"/>
            </div>
        </div>
    );
};
